...
.prop_detail .feet, .prop_detail .bedroom, .prop_detail .bathroom {
    width: 5rem;
}

/* ✅ Same button style as landlord */
...
if(isset($_POST['submit'])){
    ...
    // Insert into prop_detail (same as landlord)
    ...
    if($data){
        echo '<script>alert("Property added successfully by Admin!");</script>';
    } else {
