...
<div class="reg_container">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form_input">
            <input type="text" value="<?php echo $result['landlord_address']; ?>" name="address" placeholder="Address">
        </div>
...
if(isset($_POST['submit'])) {
    ...
    $query = "UPDATE user SET full_name='$fullname', email='$email', phone_number='$phone', password='$password',
    repeat_password='$rep_password', landlord_address='$address' WHERE id='$id'";

    $data = mysqli_query($conn, $query);

    if ($data) {
        echo '<script>alert("Data updated successfully!");</script>';
        echo '<meta http-equiv="refresh" content="0; url=http://localhost/BCA%204th%20sem%20project/admin/landlord.php" />';
    } else {
